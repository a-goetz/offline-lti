...
If you're operating out of Heroku, you're going to need a heroku_settings.py file as well, this is a copy of the settings.py file, but it won't be hidden by .gitignore. It's important not to put private stuff in here.
